...
// 导入模版，import CompName from '../packages/comp-name/index.js'  package：连字符形式的字符串
var IMPORT_TEMPLATE = 'import {{name}} from \'../packages/{{package}}/index.js\';';
// ' CompName'  '  {{name}}': 下面 {{install}} 的内容，前面的空格是 /src/index.js 里面的组件数组实例前面的空格
...
// 最后文件生成了 在 package.json scripts build:file
